...
MACRO_CONFIG_INT(SndVolume, snd_volume, 40, 0, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Sound volume")
MACRO_CONFIG_INT(SndGUIVolume, snd_gui_volume, 100, 0, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "GUI sound volume")
MACRO_CONFIG_INT(SndMusicVolume, snd_music_volume, 100, 0, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "music volume")
MACRO_CONFIG_INT(SndWorldVolume, snd_world_volume, 90, 0, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "world sound volume")
MACRO_CONFIG_INT(SndGlobalVolume, snd_global_volume, 100, 0, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "global sound volume")
MACRO_CONFIG_INT(SndMapVolume, snd_map_volume, 70, 0, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "map sound volume")
...
MACRO_CONFIG_INT(GfxQuadCulling, gfx_quad_culling, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Skip rendering map quads outside of the visible screen area")
...
MACRO_CONFIG_INT(JoystickEnable, joystick_enable, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Enable joystick")
...
MACRO_CONFIG_STR(SvMaplist, sv_maplist, 32, "all", CFGFLAG_SAVE | CFGFLAG_SERVER, "Maplist for authed clients (none, all)")
