...
int CMenus::MenuImageScan(const char *pName, int IsDir, int DirType, void *pUser)
{
	...
	MenuImage.m_OrgTexture = pSelf->Graphics()->LoadTextureRaw(Info.m_Width, Info.m_Height, 1, Info.m_Format, Info.m_pData, Info.m_Format, 0);
	...
	*/
	...
	MenuImage.m_GreyTexture = pSelf->Graphics()->LoadTextureRaw(Info.m_Width, Info.m_Height, 1, Info.m_Format, Info.m_pData, Info.m_Format, 0);
